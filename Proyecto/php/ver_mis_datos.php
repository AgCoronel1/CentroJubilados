...
<h5> Mis datos </h5>
		...
		echo "<div><div class='col-sm-4'>
				...
				. "</h4></div>
				<div class='card-body'>
				<h5 class='card-title'>DNI: ".$dni."</h5><br>
				<p class='card-text'>Fecha de Nacimiento: ".$nacimiento."<br> Telefono: ".$telefono."<br>".$nommed; 
		...
		echo "<a class='btn btn-primary' href='cambiar_datos.php'> Cambiar Datos </a> "
